...
var EscLib = /*#__PURE__*/function () {
  function EscLib() {
    _classCallCheck(this, EscLib);
    this.command = [];
    this.NEW_LINE = '\n';
    this.encoding = "utf-8";
  }
  _createClass(EscLib, [{
    ...
    key: "setPrintPaperFeed",
    value: function setPrintPaperFeed() {
      var m = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
      var str = "ESC d ".concat(m);
      this.setCommand(str);
      this.setNewLine();
    }
  }, {
